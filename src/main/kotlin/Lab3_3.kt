...
class Lab3_3: MatrixPrinter() {
    ...
    private fun getLeastSquaresPolynomial(nodes: List<Pair<Double, Double>>, degree: Int): SimpleMatrix {
        ...
        return luSolver.luSolve(luPair.first, luPair.second, rightPartVector)
    }
    ...
    fun leastSquaresInterpolation(x: Double, nodes: List<Pair<Double, Double>>, degree: Int): Double {
        ...
        for (i in 0 until polynomial.numRows()) {
            res += polynomial[i, 0]*x.pow(i)
        }
        return res
    }
